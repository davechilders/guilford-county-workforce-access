---
title: "Workforce Services Accessibility in Guilford County"
...
**Note**: Click on the various `Code` sections to view the underlying code used in producing this report. The underlying code for fetching data from the American Community [Survey](https://www.census.gov/programs-surveys/acs.html) and geocoding is available on my github [page](https://github.com/davechilders/guilford-county-workforce-access/blob/main/01-load-acs.R).
